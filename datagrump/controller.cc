...
int max_rtt = 105;				//The maximum RTT threshold
int min_rtt = 62;				//The minimum RTT threshold
int error_sum_bound = 600;		//The largest +/- error_sum allowed
int error_reset_threshold = 5;	//Amount of fuzziness for resetting error_sum
int error_threshold_nudge = 4;	//Amount to nudge error when outside threshold
...
Power: 33.69 MBits/s^2 (Average Throughput / Signal Delay)
